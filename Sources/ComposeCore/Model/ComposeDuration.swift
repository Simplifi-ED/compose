...
enum ComposeDuration {
  static func parse(_ raw: String, field: String, allowZero: Bool = false) throws -> Duration {
    ...
    while index < trimmed.endIndex {
      ...
      case "us":
        nanoseconds = Int64(value * 1_000)
      case "ms":
        nanoseconds = Int64(value * 1_000_000)
      case "s":
        nanoseconds = Int64(value * 1_000_000_000)
      case "m":
        nanoseconds = Int64(value * 60 * 1_000_000_000)
      case "h":
        nanoseconds = Int64(value * 3_600 * 1_000_000_000)
      default:
